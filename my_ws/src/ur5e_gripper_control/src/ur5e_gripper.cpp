...
UR5eGripper::UR5eGripper(const rclcpp::NodeOptions &options)
  ...
  wrist_yaw_sub_ = this->create_subscription<std_msgs::msg::Float64>(
      wrist_yaw_topic, 10,
      std::bind(&UR5eGripper::wrist_yaw_callback, this, std::placeholders::_1));
...
void UR5eGripper::wrist_yaw_callback(const std_msgs::msg::Float64::SharedPtr msg) {
...
bool UR5eGripper::get_latest_wrist_yaw(double &yaw_value, double max_age_sec) {
  std::lock_guard<std::mutex> lock(wrist_yaw_mutex_);
